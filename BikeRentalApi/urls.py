...
from .views import bikes_list, bikes_detail, bikes_rented, stations_list, stations_detail, stations_detail_bikes, \
    ...
    stations_detail_bikes_all, malfunctions_detail, bikes_reserved, bikes_reserved_detail
...
urlpatterns = [
    ...
    re_path(r'^bikes/reserved/(?P<pk>[0-9]+)/?$', bikes_reserved_detail, name = 'bikes_reserved_detail'),
    ...
    re_path(r'^malfunctions/(?P<pk>[0-9]+)/?$', malfunctions_detail, name = 'malfunctions_detail'),
]
